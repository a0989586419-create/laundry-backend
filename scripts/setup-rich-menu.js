...
const MENUS = {
  ...
  b2c: {
    ...
    areas: [
      { bounds: { x: 0, y: 0, width: 833, height: 843 }, action: { type: 'uri', label: '查空機', uri: `${LIFF_BASE}?tab=wash` } },
      { bounds: { x: 833, y: 0, width: 834, height: 843 }, action: { type: 'uri', label: '線上儲值', uri: `${LIFF_BASE}?tab=profile` } },
      { bounds: { x: 1667, y: 0, width: 833, height: 843 }, action: { type: 'uri', label: '我的帳戶', uri: `${LIFF_BASE}?tab=profile` } },
      { bounds: { x: 0, y: 843, width: 833, height: 843 }, action: { type: 'uri', label: '優惠券', uri: `${LIFF_BASE}?tab=coupons` } },
      { bounds: { x: 833, y: 843, width: 834, height: 843 }, action: { type: 'message', label: '洗衣教學', text: '教學' } },
  ...
  b2b: {
    ...
    areas: [
      ...
      { bounds: { x: 833, y: 0, width: 834, height: 843 }, action: { type: 'message', label: '成功案例', text: '成功案例' } },
      { bounds: { x: 1667, y: 0, width: 833, height: 843 }, action: { type: 'message', label: '免費Demo', text: '免費Demo' } },
      { bounds: { x: 0, y: 843, width: 833, height: 843 }, action: { type: 'message', label: '獲利分析', text: '獲利分析' } },
